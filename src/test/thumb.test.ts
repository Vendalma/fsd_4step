...
describe('Thumb', ()=> {
    ...
    describe('проверка метода findPosition', () => {
        ...
        let thumbFirst = thumb.slider.querySelector(".thumb_first") as HTMLElement;
        let thumbSecond = thumb.slider.querySelector(".thumb_second") as HTMLElement;
